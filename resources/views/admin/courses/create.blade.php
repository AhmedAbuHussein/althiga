                ...
                <div class="tab-content pt-5" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="accreditation_num" value="{{ old('accreditation_num') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="is_popular" id="is_popular" class="form-control" required>
                                        <option value="">@lang('site.select')</option>
                                        <option {{ old('is_popular') == '1' ? 'selected' : '' }} value="1">
                                            @lang('site.yes')</option>
                                        <option {{ old('is_popular') == '0' ? 'selected' : '' }} value="0">
                                            @lang('site.no')</option>
                                    </select>
                                    @error('is_popular')
                                        <p class="text-danger">{{ $message }}</p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="main_header" id="main_header" class="form-control" required>
                                        <option value="">@lang('site.select')</option>
                                        <option {{ old('main_header') == '1' ? 'selected' : '' }} value="1">
                                            @lang('site.yes')</option>
                                        <option {{ old('main_header') == '0' ? 'selected' : '' }} value="0">
                                            @lang('site.no')</option>
                                    </select>
                                    @error('main_header')
                                        <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="form-group d-flex justify-content-end" style="margin-top: 40px">
                            <button type="button" onclick="goTo('#tab2-tab')"
                    ...
                    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        ...
                        <div class="form-group d-flex justify-content-between" style="margin-top: 40px">
                            <button type="button" onclick="goTo('#tab1-tab')"
                                class="btn btn-info">@lang('site.prev')</button>
                            <button type="button" onclick="goTo('#tab3-tab')"
                                class="btn btn-primary">@lang('site.next')</button>
                        </div>
                    </div>
                    {{--  end tab 2  --}}
                    ...
                    <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                        ...
                        <div class="form-group d-flex justify-content-between" style="margin-top: 40px">
                            <button type="button" onclick="goTo('#tab2-tab')"
                                class="btn btn-info">@lang('site.prev')</button>
                            <button type="button" onclick="goTo('#tab4-tab')"
                                class="btn btn-primary">@lang('site.next')</button>
                        </div>
                    </div>
                    {{--  end tab 3  --}}
                    ...
                    <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="show_single_price" id="show_single_price" class="form-control" required
                                        ...
                                        <option value="">@lang('site.select')</option>
                                        <option {{ old('show_single_price') == '1' ? 'selected' : '' }} value="1">
                                            @lang('site.yes')</option>
                                        <option {{ old('show_single_price') == '0' ? 'selected' : '' }} value="0">
                                            @lang('site.no')</option>
                                    </select>
                                ...
                                <div class="d-none" id="role-single">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price_role[en]" value="{{ old('price_role.en') }}"
                                            class="form-control">
                                        @error('price_role.en')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="price_role[ar]" value="{{ old('price_role.ar') }}"
                                            class="form-control">
                                        @error('price_role.ar')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="show_group_price" id="show_group_price" class="form-control" required
                                        ...
                                        <option value="">@lang('site.select')</option>
                                        <option {{ old('show_group_price') == '1' ? 'selected' : '' }} value="1">
                                            @lang('site.yes')</option>
                                        <option {{ old('show_group_price') == '0' ? 'selected' : '' }} value="0">
                                            @lang('site.no')</option>
                                    </select>
                                ...
                                <div id="show-group-price" class="d-none">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="group_price" value="{{ old('group_price') }}"
                                            class="form-control">
                                        @error('group_price')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" step="0.5" max="100"
                                            name="discount_group_price" value="{{ old('discount_group_price') }}"
                                            class="form-control">
                                ...
                                <div class="d-none" id="role-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="group_price_role[en]"
                                            value="{{ old('group_price_role.en') }}" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="group_price_role[ar]"
                                            value="{{ old('group_price_role.ar') }}" class="form-control">
                        ...
                        <div class="form-group d-flex justify-content-between" style="margin-top: 40px">
                            <button type="button" onclick="goTo('#tab3-tab')"
                                class="btn btn-info">@lang('site.prev')</button>
                            <button type="button" onclick="goTo('#tab5-tab')"
                                class="btn btn-primary">@lang('site.next')</button>
                        </div>
                    </div>
                    {{--  end tab 4  --}}
