                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[en]" class="form-control" value="{{ old('title.en', $tour->getTranslation('title', 'en')) }}">
                                    @error('title.en')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[ar]" class="form-control" value="{{ old('title.ar', $tour->getTranslation('title', 'ar')) }}">
                                    @error('title.ar')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="text[en]" class="form-control" rows="5">{{ old('text.en', $tour->getTranslation('text', 'en')) }}</textarea>
                            @error('text.en')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="text[ar]" class="form-control" rows="5">{{ old('text.ar', $tour->getTranslation('text', 'ar')) }}</textarea>
                            @error('text.ar')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
