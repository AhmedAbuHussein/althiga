                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title[en]" class="form-control" value="{{ old('title.en', $partner->getTranslation('title', 'en')) }}">
                            @error('title.en')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title[ar]" class="form-control" value="{{ old('title.ar', $partner->getTranslation('title', 'ar')) }}">
                            @error('title.ar')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="link" type="url" class="form-control" placeholder="@lang('site.external_link')" value="{{ old('link', $partner->link) }}">
                            @error('text.en')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
