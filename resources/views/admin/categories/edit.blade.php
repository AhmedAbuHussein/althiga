                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[en]" class="form-control" value="{{ old('title.en', $category->getTranslation('title', 'en')) }}">
                                    @error('title.en')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[ar]" class="form-control" value="{{ old('title.ar', $category->getTranslation('title', 'ar')) }}">
                                    @error('title.ar')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="text[en]" class="form-control" rows="5">{{ old('text.en', $category->getTranslation('text', 'en')) }}</textarea>
                            @error('text.en')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check form-switch mt-3">
                            <input class="form-check-input" {{ old('show_in_menu', $category->show_in_menu) == "1"  ? 'checked' :'' }} name="show_in_menu" value="1"  type="checkbox" id="check">
