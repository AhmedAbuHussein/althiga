                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[en]" class="form-control" value="{{ old('title.en', $accreditation->getTranslation('title', 'en')) }}">
                                    @error('title.en')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title[ar]" class="form-control" value="{{ old('title.ar', $accreditation->getTranslation('title', 'ar')) }}">
                                    @error('title.ar')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control" id="type">
                                ...
                                <option {{ old('type', $accreditation->type) == 'national' ? 'selected': '' }} value="national">@lang('site.national')</option>
                                <option {{ old('type', $accreditation->type) == 'international' ? 'selected': '' }} value="international">@lang('site.international')</option>
                            </select>
                            @error('type')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div id="text">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="text[ar]" class="form-control" placeholder="@lang('site.ar_extra_ex')" value="{{ old('text.ar', $accreditation->getTranslation('text', 'ar')) }}" >                               
                                @error('text.ar')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div id="file_type">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="file_title[en]" class="form-control" value="{{ old('file_title.en', $accreditation->getTranslation('file_title', 'en')) }}">
                                        @error('file_title.en')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="file_title[ar]" class="form-control" value="{{ old('file_title.ar', $accreditation->getTranslation('file_title', 'ar')) }}">
                                        @error('file_title.ar')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ $accreditation->fileUrl }}" download="">@lang('site.download file')</a>
                                {{--  download link  --}}
                            </div>
