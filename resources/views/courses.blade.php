    ...
    <div class="page-title-section" style="background-image: url({{ asset('web/img/sub-pages-background.png') }});">
        <div class="container">
            ...
            <ul class="fa">
                ...
                <li><a href="#">@lang('Courses_Schedule')</a></li>
            </ul>
        </div>
    </div>
    <!-- Page Title END -->
    ...
    <div class="section-block-grey">
        <div class="container">
            <div class="section-heading row">
                <div class="col-md-8">
                    <h4>@lang('Courses_Schedule')</h4>
                    <div class="section-heading-line-right"></div>
                </div>
                <div class="col-md-4">
                    <form action="{{ route('courses.index') }}" style="position: relative">
                        <input type="search" name="_q" value="{{ request()->get('_q') }}" class="form-control" style="padding-left: 45px;" placeholder="@lang('search')">
